...
func BuildOpenAPISpec() map[string]any {
	schemas := map[string]any{
		...
		"ListenerView": map[string]any{
			...
			"required": []string{"name", "type", "listen", "port", "udp", "users", "userCount", "egressGroup", "status", "groupMissing", "providerMissing", "providerDisabled", "landingMissing", "landingDisabled"},
		},
